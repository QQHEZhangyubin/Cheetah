...
public interface APIService {
    ...
    //请求七牛云tokenimg
    @POST("tokenvideo")
    Observable<Token> GETTOKENVIDEO();
    //请求所有的说说
    @POST("talk/request")
    ...
    @POST("uploadtouxiang2")
    Observable<Status> uploadTouxiangImgs2(@Query("touxiangurl") String touxiangurl, @Query("userid") String userid);
