...
public class APIWrapper extends RetrofitUtil {
    ...
    public Observable<Token> GETTOKENVIDEO (){
        return getmAPIService().GETTOKENVIDEO();
    }
    public Observable<Token> GETTOKEN(){
        return getmAPIService().GETTOKEN();
    }
    ...
    public Observable<Status> uploadTouxiangImgs2(String touxiangurl,String userid){
        return getmAPIService().uploadTouxiangImgs2(touxiangurl,userid);
    }
