...
import com.example.desk.entity.DataBean;
...
public class RegisterActivity extends MVPBaseActivity<RegisterContract.View, RegisterPresenter> implements RegisterContract.View {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dataBean = new DataBean();//实例化一个databean
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_signup:
                ...
                builder.setTitle("提醒");
                builder.setMessage(getResources().getString(R.string.tipss));
                ...
                builder.setNegativeButton("去修改", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        alertDialog.dismiss();
                    }
